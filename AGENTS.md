...
- **CEIQ (ceiqinc.com) is a public marketing landing page app**: It's built with Laravel + Blade + vanilla CSS and Javascript.
...
-**Prefer Blade components**Do not use Livewire or Inertia. If you need interactivity, use Alpine.js in Blade components.
...
- **MySQL 8 database.** The local development environment uses MySQL 8 and the database name is ceiq-web, so all code should be compatible with it.
